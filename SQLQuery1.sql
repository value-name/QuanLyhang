...
VALUES 
    (N'ND01', N'Nguyễn Văn A',N'tk01@gmail.com', N'093847128', N'Hà Nội', N'nhan vien'),
    (N'ND02', N'Nguyễn Văn B', N'tk02@gmail.com', N'0987654321', N'Hồ Chí Minh', N'admin');
...
VALUES 
    (N'TK01', N'admin', N'admin', N'tk01@gmail.com', N'ND01', N'hoat dong', GETDATE(), N'nhan vien'),
    (N'TK02', N'user', N'user', N'tk02@gmail.com', N'ND02', N'hoat dong', GETDATE(), N'admin');
